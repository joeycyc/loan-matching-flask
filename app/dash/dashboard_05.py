...
def get_gantt_3(matching_object, stage_to_display, projects_to_display,
                chart_type=1, bar_height=30, trace_height_range=(0.25, 1.0), *args, **kwargs):
    """Visualize data in gantt chart - version 3:
     5 subplots for shortfall+matched, leftover, total shortfall, equity, set aside for acquisition
     color = amount
     2 types: Simple Gantt Chart with uniform bar height, or with different bar widths according to the loan amount
    Args:
        - matching_object: LoanMatching object
        - stage_to_display: str, 'stage (0|1|2|...)'
        - projects_to_display: list of strings of project names
        - chart_type: int, 1 = Simple Gantt Chart, 2 = Gantt Chart with different bar height
    ...
    for g_idx, g in enumerate(gantts):
        ...
        # Set trace_height - relative height from given range, applicable for chart type #2 only
        if chart_type == 2:
...
def add_dashboard(server):
                ...
                html.Div([
                    ...
                    html.Div([
                        ...
                        dcc.Input(id='tpp-date-delta-year', type='number', placeholder='Year',
                                  ...
                                  style={'width': '3vw', 'max-width': '48px'}),
                        html.Label(' years '),
                    ...
                    html.Div([
                        ...
                        dcc.Input(id='input-equity-amt', type='number', placeholder='Equity',
                                  ...
                                  style={'width': '4vw', 'max-width': '64px'}),
                        html.Label('B'),
                        html.Br(),
                    ]),
                    # Manual matching
                    ...
                    html.Div([
                        ...
                        dcc.Input(id='cr-ceiling', type='number',
                                  ...
                                  style={'width': '4vw', 'max-width': '64px', 'vertical-align': 'middle'}),
                        ...
                        dcc.Dropdown(id='cr-ceiling-to-stay',
                                     ...
                                     clearable=False,
                                     style={'width': '10vw', 'max-width': '160px',
                ...
                html.Div([
                    ...
                    html.Div([
                        ...
                        dcc.Dropdown(id='filter-stage',
                                     ...
                                     value=all_stages[0],
                                     clearable=False,
                                     style={'width': '36vw', 'max-width': '576px'}),
                    ]),
                    html.Div([
    ...
    def update_plot(*args):
        ...
        if chart_type == 11:
            ...
            fig = get_gantt_3(matching_object, stage_to_display, projects_to_display,
                              chart_type=1, bar_height=bar_height)
        elif chart_type == 23:
            fig = get_gantt_3(matching_object, stage_to_display, projects_to_display,
                              chart_type=2, bar_height=bar_height, trace_height_range=tuple(bar_height_range))
        else:
            pass
